        ...
        <div id="swup" class="main-content transition-in">
          <section class="introduction">
            <div class="-inner">
              <div class="description">
                <p>
                  I'm a Chilean 🇨🇱 User Experience designer working in services and products. I use service-design tools 🔧 and a design thinking approach 🧠 to convert ideas into solutions 💥.
                </p>
                <p>
                  Currently, I’m designing a service with <a href="#">The Cocktail</a> for <a href="#">Banco Santander</a>.
                </p>
              </div>
          ...
          <section class="what-i-do">
            ...
            <div class="-inner">
              ...
              <div class="--defining">
                <div>
                  <h2 class="-title" data-aos="fade-in">Defining</h2>
                  <p data-aos="fade-in">
